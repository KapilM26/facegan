...
def create_discriminator():
    ...
    x = L.LeakyReLU()(x)
    x = L.Conv2D(filters=128, kernel_size=(5, 5), padding='same', strides=(2,2))(inp)
    x = L.LeakyReLU()(x)
    x = L.Conv2D(filters=256, kernel_size=(5, 5), padding='same', strides=(2,2))(inp)
    x = L.LeakyReLU()(x)
    x = L.Conv2D(filters=512, kernel_size=(5, 5), padding='same', strides=(2,2))(inp)
    x = L.LeakyReLU()(x)
    x = L.Conv2D(filters=1024, kernel_size=(5, 5), padding='same', strides=(2,2))(inp)
    x = L.LeakyReLU()(x)
    x = L.Flatten()(x)
    x = L.Dense(1)(x)
